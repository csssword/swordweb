 ...
 * @see #prepare
 * @see #invoke
 * @see com.css.sword.platform.comm.beanfactory.config.MethodInvokingFactoryBean
 * @see com.css.sword.platform.comm.scheduling.quartz.MethodInvokingJobDetailFactoryBean
 */
public class MethodInvoker {
     ...
     * @see #setTargetMethod
     */
    public void setStaticMethod(String staticMethod) throws
        ...
        setTargetClass(Class.forName(className, true,
    ...
    public void prepare() throws ClassNotFoundException, NoSuchMethodException {
        ...
        Class<? extends Object> targetClass = (this.targetObject != null) ?
            this.targetObject.getClass() : this.targetClass;
        try {
        ...
        if (this.targetObject == null &&
            ...
            throw new IllegalArgumentException(
                "Target method must not be static without a target");
        }
    }
    ...
    public Object invoke() throws InvocationTargetException,
        ...
        Object result = this.methodObject.invoke(this.targetObject,
                                                 this.arguments);
