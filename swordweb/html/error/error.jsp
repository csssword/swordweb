<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
        <%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
<HTML><HEAD><TITLE>Sword 出错信息提示</TITLE>
    <META http-equiv=Content-Type content="text/html; charset=utf-8">

<!--<META http-equiv=Content-Type content="text/html; charset=utf-8"><LINK -->
<!--name="GENERATOR" content="MSHTML 6.00.2600.0" </META>-->
<!--<META http-equiv=refresh content=8;url=http://www.suqun.net>-->
...
BODY {
	SCROLLBAR-FACE-COLOR: #eeeeee; BACKGROUND-IMAGE: url(/skin/skin_1/bg.gif); SCROLLBAR-HIGHLIGHT-COLOR: #ffffff; SCROLLBAR-SHADOW-COLOR: #dee3e7; SCROLLBAR-3DLIGHT-COLOR: #d1d7dc; SCROLLBAR-ARROW-COLOR: #000000; SCROLLBAR-TRACK-COLOR: #ededed; SCROLLBAR-DARKSHADOW-COLOR: #808080; BACKGROUND-COLOR: #ffffff
}
INPUT {
...
<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD><IMG src="swordweb/html/error/404/1.gif" width="17" height="18"></TD>
    <TD width="100%" 
    background="swordweb/html/error/404/3.gif"></TD>
    <TD><IMG 
src="swordweb/html/error/404/2.gif" width="17" height="18"></TD>
  </TR></TBODY></TABLE>
<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD width=7 
background="swordweb/html/error/404/left.gif"></TD>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="98%" align=center border=0>
        ...
        <TR>
          <TD align=left width="80%" 
            height=30>&nbsp;您现在位于：&nbsp;<A 
            href="http://www.suqun.net/"></A><FONT 
            title=出错信息提示>出错信息提示</FONT> </TD>
          <TD align=right width="20%">
            <DIV id=div_msg>
            <MARQUEE onMouseOver="if (document.all!=null){this.stop()}" 
            onmouseout="if (document.all!=null){this.start()}" scrollAmount=3 
            scrollDelay=100><IMG 
            src="swordweb/html/error/404/gao.gif" width="19" height="17"> <FONT
            class=red>sword 4.5 版权所有</FONT>
            </MARQUEE></DIV></TD></TR></TBODY></TABLE></TD>
    <TD width=7 
    background="swordweb/html/error/404/right.gif"></TD></TR></TBODY></TABLE>
<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD width=7 
        ...
        <TR>
          <TD class=bg_1 align=middle height=300>
            <TABLE cellSpacing=0 cellPadding=0 width=590 border=0>
              ...
              <TR>
                <TD align=right><IMG 
                  src="swordweb/html/error/404/center_error.gif" width="450" height="32"
                  border=0></TD>
              </TR>
              <TR>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width=534 border=0>
                    ...
                    <TR>
                      <TD colSpan=3><IMG height=42 
                        src="swordweb/html/error/404/error_r1_c1.gif"
                        width=534 border=0></TD>
                      <TD><IMG height=42 
                        src="swordweb/html/error/404/60du.htm"
                        width=1 border=0></TD></TR>
                    <TR>
                      <TD rowSpan=2><IMG height=239 
                        src="swordweb/html/error/404/error_r2_c1.gif"
                        width=43 border=0></TD>
                      <TD class=htd align=left width=479 bgColor=#f7f7f7 
                      height=228>
                          <P><FONT class=red>错误名称：</FONT><BR>
                              <%=request.getAttribute("exceptionName")%>
                              <BR>
                          </P>
                          <P>
                          <FONT class=red>错误信息：</FONT>
                          <BR>
                          <%=request.getAttribute("exceptionMes")%>
                           </P>
                          <BR><BR><BR>
                          <P>
                           详细请检查控制台的异常堆栈和日志信息。
                      ...
                      <TD rowSpan=2><IMG height=239 
                        src="swordweb/html/error/404/error_r2_c3.gif"
                    ...
                    <TR>
                      <TD><IMG height=11 
                        src="swordweb/html/error/404/error_r3_c2.gif"
                        width=479 border=0></TD>
                      <TD><IMG height=11 
                        src="swordweb/html/error/404/60du.htm"
                        width=1       border=0></TD></TR></TBODY></TABLE><BR></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD>
    <TD width=7 
    background="swordweb/html/error/404/right.gif"></TD></TR></TBODY></TABLE>
<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD class=bg align=middle width=*>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD><IMG src="swordweb/html/error/404/4.gif" width="17" height="18"></TD>
          <TD width="100%" 
          background="swordweb/html/error/404/6.gif"></TD>
          <TD><IMG 
        src="swordweb/html/error/404/5.gif" width="17" height="18"></TD>
        </TR></TBODY></TABLE><BR>
